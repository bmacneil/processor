...
void OUTPUT_PORT::state() {
  ...
  std::cout << "o_branch       " << o_branch << std::endl;
  ...
  std::cout << "o_aluop        " << o_aluop << std::endl;
...
void OUTPUT_PORT::o_branch_test() {
  if (!bitTest(o_branch, m_core->o_branch))
    std::cout << "o_branch_test FAILED" << std::endl;
}
...
void OUTPUT_PORT::o_aluop_test() {
  if (!bitTest(o_aluop, m_core->o_aluop))
    std::cout << "o_aluop_test FAILED" << std::endl;
}
